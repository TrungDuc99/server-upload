...
FileRouter.post('/uploadfile', AuthenticateToken_1.authenticateToken, file_1.upload.single('file'), file_2.default.uploadFile);
FileRouter.post('/uploadmultiple', AuthenticateToken_1.authenticateToken, file_1.upload.array('files', 12), file_2.default.uploadmultiple);
